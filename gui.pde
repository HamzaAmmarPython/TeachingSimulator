...
public void button4_click1(GButton source, GEvent event) { //_CODE_:button4:219060:
  if (teacher.teaching == true) {
    ...
    button4.setLocalColorScheme(G4P.RED_SCHEME);
  }
...
public void cryClicked(GButton source, GEvent event) { //_CODE_:Cry:589739:
    ...
    for (int k=0; k<numStudents; k++) {
      try {
        //Crying 
        C.Students[k].rowdiness += random(1,2);
...
public void button1_click1(GButton source, GEvent event) { //_CODE_:button1:929331:
  for (int k=0; k<numStudents; k++) {
      try {
        C.Students[k].takeTest();
      }
      catch (Exception e) {
        println();
      }
...
public void createGUI(){
  ...
  button3 = new GButton(this, 164, 129, 80, 30);
  button3.setText("Answer");
  button3.addEventHandler(this, "button3_click1");
  button4 = new GButton(this, 163, 91, 80, 30);
  button4.setText("Teach");
  button4.addEventHandler(this, "button4_click1");
  Cry = new GButton(this, 165, 165, 80, 30);
  Cry.setText("Cry");
